Данный репозиторий представляет из себя попытку восстановить исходный код коллекционной карточной игры Warhammer: Horus Heresy Legions.

В этом ReadMe будет описан процесс декомпиляции и восстановления.
